...
public class updater : MonoBehaviour
{
    ...
    {   
        ...
        float orbit = pos.magnitude*attribute.convFactor;
        ...
        if (attribute.overheat > 0f || attribute.speed > attribute.maxSpeed) {
            updateMethod.Heat((attribute.speed - attribute.maxSpeed)*attribute.overheatFactor/attribute.convFactor);
        }
        ...
        updateMethod.removeFuel(thrust*attribute.fuelFactor/attribute.convFactor);

        attribute.speed = velocity.magnitude*attribute.convFactor/1000f;
    }
}
